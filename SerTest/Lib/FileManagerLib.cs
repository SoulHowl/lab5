   ...
   public  class CryptOptions
    {
        ...
        public async Task<string> DecryptfAsync(string path)
        {
        ...
        public async Task<string> EncryptfAsync(string newtargetpath)
        {
            return await Task.Run(() =>
            {
    ...
    public class CopyOptions
    {
        ...
        public async Task<string> CopystrAsync(string stpath, string Targetpath)
        {
            return await Task.Run(() =>
            {
    ...
    public class ArchiveOptions
    {
        ...
        public async Task<string> ArchivizeCryptAsync(string tpath)
        {
            return await Task.Run(() =>
            {
        ...
        public async Task<string> DearchivizeCryptAsync(string newpath)
        {
            return await Task.Run(() =>
            {
        ...
        public async Task Do(string filePath)
        {
            await Task.Run(async() =>
            {
                ...
                if (val.CheckFile(filePath))
                {
                    ...
                    var cryptstr = await cryptOptions.DecryptfAsync(filePath);
                    var archstr = await archivizeOptions.ArchivizeCryptAsync(cryptstr);
                    var newstr = await copyOptions.CopystrAsync(archstr, pathes.Target1);
                    var newcrypt = await archivizeOptions.DearchivizeCryptAsync(newstr);
                    var getstr = await cryptOptions.EncryptfAsync(newcrypt);
                    await ArchAsync(getstr);
                   
                }
            });
        }

        public async Task ArchAsync(string getstr)
        {
            await Task.Run(() =>
            {
